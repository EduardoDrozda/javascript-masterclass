...
console.log(
  "Manager.prototype.__proto__ === Supervisor.prototype.__proto__",
...
console.log(
  "Supervisor.prototype.isPrototypeOf(new Manager())",
  Supervisor.prototype.isPrototypeOf(new Manager())
);
assert.deepStrictEqual(Supervisor.prototype.isPrototypeOf(new Manager()), true);
